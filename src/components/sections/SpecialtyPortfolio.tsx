  ...
  return (
    <section className="bg-[#f4f0e6] py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="max-w-3xl font-display text-4xl font-extrabold text-slate-950 sm:text-5xl">Botanical oils, biostimulants and specialist inputs.</h2>
        ...
        {showPortfolioLink && <div className="mt-10 text-center"><Link href="/products/" className="inline-flex items-center gap-2 rounded-full border border-slate-900/20 bg-white px-6 py-3 text-base font-bold text-slate-900">Explore all products <ArrowRight className="h-4 w-4" /></Link></div>}
      </div>
    </section>
  );
}
